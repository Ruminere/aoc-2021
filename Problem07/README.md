...
Another set of cute problems. Granted, you'd be in for a wild ride if you don't know the shortcuts beforehand and brute force the solution (meaning your code goes through every single position), but it still was fun.
