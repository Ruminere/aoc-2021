...
I started this problem on December 16, did not understand it, and then tried again on December 27. This problem was pretty hard to understand. I took some notes on the problem to organize my thoughts better. However, once I understood the problem, I found it a lot of fun (though slightly tedious) to implement.

![image](notes.jpg)

On December 16, my partial solution took the substring of the original binary string multiple times.

On December 27, I realized that literal values end after a group with a "`0`". That wasn't explicitly mentioned in my notes. I also scrapped my original partial solution and decided to increment by the index, as it was clear that I'd have to do this recursively as the end of one subpacket meant the beginning of the next.
